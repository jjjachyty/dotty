...
// File: dotty_prd_flat.sol


// File: contracts/dotty_prd.sol
...
contract MyToken is ERC20 {
    ...
    uint256 public _swapOrDividend;
    ...
    constructor() ERC20("Dotty Token", unicode"Dotty🎁", 22222 * 10**decimals()) {
        ...
        _rewardBaseLPFirst = 10 * 10**18; //TODO:
        _rewardBaseLPSecond = 0.5 * 10**18; //TODO:
        ...
        tradingEnabledTimestamp = 1650637342;
        ...
        _whitelist[0xF4b72b551b384228197255BEE56E5f68E552ba17] = true;
        _whitelist[0x00a96a124c1be4d1eebACd3bB29D12648615b210] = true;
    ...
    function setLastProcessedIndex(uint256 _lastProcessedIndex) public onlyOwner {
